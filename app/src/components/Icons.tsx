...
export function EuroIcon({ className = '', size = 24 }: IconProps) {
  return (
...
export function BarChart3Icon({ className = '', size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M3 3v16a2 2 0 0 0 2 2h16" /><rect x="15" y="5" width="4" height="12" rx="1" />
...
export function ExternalLinkIcon({ className = '', size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function PowerBIIcon({ className = '', size = 28 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M12 2v20" /><path d="M17 5v8" /><path d="M7 8v5" /><path d="M17 16v2" /><path d="M7 18v1" />
    </svg>
  );
}

export function PythonIcon({ className = '', size = 28 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M12 2C6.5 2 6 4.5 6 6v2h6v1H5c-2 0-3 1.5-3 4s1 4 3 4h2v-3c0-2 1.5-3 3-3h5c1.5 0 2-1 2-2V6c0-2-1-4-6-4z" />
      <path d="M12 22c5.5 0 6-2.5 6-4v-2h-6v-1h7c2 0 3-1.5 3-4s-1-4-3-4h-2v3c0 2-1.5 3-3 3H9c-1.5 0-2 1-2 2v4c0 2 1 4 6 4z" />
    </svg>
  );
}
